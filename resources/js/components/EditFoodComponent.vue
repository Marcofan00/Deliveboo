<template>
    <div :class="hamburgermenu? 'if_open' : ''" id="edit_food" class="container container_xxl_">
        ...
        <form >
            ...
            <div class="data">
                ...
                <textarea name="description_ingredients" id="" rows="10" v-model.trim="descriptionIngredients" required placeholder="Min 100 caratteri"></textarea>
